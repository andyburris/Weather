...
data class WeatherKitDailyConditions(
    ...
    @field:Json(name = "moonset") val moonset: String? = null,
    @field:Json(name = "precipitationAmount") val precipitationAmount: Double,
    @field:Json(name = "precipitationAmountByType") val precipitationAmountByType: WeatherKitPrecipitationAmountByType,
    @field:Json(name = "precipitationChance") val precipitationChance: Double,
    @field:Json(name = "precipitationType") val precipitationType: WeatherKitPrecipitationType,
    @field:Json(name = "snowfallAmount") val snowfallAmount: Double,
    @field:Json(name = "solarMidnight") val solarMidnight: String? = null,
    @field:Json(name = "solarNoon") val solarNoon: String? = null,
    @field:Json(name = "sunrise") val sunrise: String,
    @field:Json(name = "sunriseCivil") val sunriseCivil: String? = null,
    @field:Json(name = "sunriseNautical") val sunriseNautical: String? = null,
    @field:Json(name = "sunriseAstronomical") val sunriseAstronomical: String? = null,
    @field:Json(name = "sunset") val sunset: String,
    @field:Json(name = "sunsetCivil") val sunsetCivil: String? = null,
    @field:Json(name = "sunsetNautical") val sunsetNautical: String? = null,
    @field:Json(name = "sunsetAstronomical") val sunsetAstronomical: String? = null,
